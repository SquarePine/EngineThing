#ifndef SQUAREPINE_PIXEL_FORMATS_H
#define SQUAREPINE_PIXEL_FORMATS_H
    ...
    */
    ...
    forcedinline void unpremultiply() noexcept
    {
        ...
        if (alpha < 0xff)
        {
            ...
            {
                components.b = (uint8) std::min ((uint32) 0xffu, (components.b * 0xffu) / alpha);
                components.g = (uint8) std::min ((uint32) 0xffu, (components.g * 0xffu) / alpha);
                components.r = (uint8) std::min ((uint32) 0xffu, (components.r * 0xffu) / alpha);
            }
        }
    }
...
#endif //SQUAREPINE_PIXEL_FORMATS_H