#ifndef SQUAREPINE_POINT_H
#define SQUAREPINE_POINT_H
...
public:
    ...
    */
    ...
    Point<int> roundToInt() const noexcept         { return Point<int> (roundToInt (x), roundToInt (y)); }
